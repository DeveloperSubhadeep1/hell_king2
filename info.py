...
BOT_TOKEN = environ.get('BOT_TOKEN','6753180750:AAE5RnS9Z-WTb8jeOxQnDUj5ppcKEd0xDn0')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002027500917') # support group id ( make sure bot is admin )
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+9mMEdrImgIJjYTg9') #Support group link ( make sure bot is admin )
